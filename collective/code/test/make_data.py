...
def sim_distance( prefs,person1,person2 ):
    ...
    #计算距离 
    #for item in si:
    #    sum_of_squares = sqrt( pow(prefs[person1][item] - prefs[person2][item],2)) + sum_of_squares 
...
#测试
#print sim_distance( critics,'3', '2')
#print sim_pearson( critics,'3', '2')
#print topMatches( critics, '3',10)
#res = getRecommendations( critics , '1')
#print len(res)
